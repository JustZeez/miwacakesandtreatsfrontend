...
export default function Treats() {
  ...
  {/* Separate Out of Stock button with different styling */}
  <Link
    to="/coming-soon"
    className="inline-flex items-center gap-2 px-6 py-2 rounded-full border-2 transition-all duration-300 font-medium border-amber-500 text-amber-600 hover:bg-amber-500 hover:text-white bg-amber-50 hover:scale-105 hover:shadow-lg"
  >
